<div>
    <div class="space-y-5">
        <div class="sm:flex justify-between">
            <div class="w-full mb-3 md:w-2/4 md:mb-0">
                <input wire:model="search" type="text" class="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 transition ease-in-out duration-150 focus:outline-none focus:ring focus:ring-indigo-500 focus:ring-opacity-20 focus:border-indigo-300 sm:text-sm" placeholder="Search Income..." />
            </div>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @forelse($incomes as $income)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 text-right whitespace-nowrap">
                                            <p class="text-sm text-gray-500">{{ $income->entry_date->format('M, d Y') }}</p>
                                        </td>
                                        <td class="px-6 py-4 space-x-1.5 whitespace-nowrap text-right text-sm font-medium">
                                            <button wire:click="edit({{ $income->id }})" type="button" class="focus:outline-none">
                                            ...
                                            <button wire:click="selectedItem({{ $income->id }})" type="button" class="focus:outline-none">
                                                <svg class="w-5 h-5 text-gray-600 hover:text-gray-900" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <x-modal.dialog wire:model.defer="showSaveModal">
            ...
            <x-slot name="content">
                <div class="mt-6 sm:mt-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
                    ...
                    <div class="mt-1 sm:mt-0 sm:col-span-2">
                        <div class="max-w-xs relative rounded-md shadow-sm">
                            <x-input.date wire:model="income.entry_date" id="date" />
                        </div>

                        @error('income.entry_date')
                ...
                <div class="mt-6 sm:mt-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
                    ...
                    <div class="mt-1 sm:mt-0 sm:col-span-2">
                        <div class="max-w-xs rounded-md shadow-sm">
                            <input wire:model.lazy="income.title" type="text" id="title" class="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 transition ease-in-out duration-150 focus:outline-none focus:ring focus:ring-indigo-500 focus:ring-opacity-20 focus:border-indigo-300 sm:text-sm" />
                        </div>
                ...
                <div class="mt-6 sm:mt-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
                    ...
                    <div class="mt-1 sm:mt-0 sm:col-span-2">
                        <div class="max-w-xs rounded-md shadow-sm">
                            <select wire:model="income.category_id" id="category" class="block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm transition ease-in-out duration-150 focus:outline-none focus:ring focus:ring-indigo-500 focus:ring-opacity-20 focus:border-indigo-300 sm:text-sm">
                ...
                <div class="mt-6 sm:mt-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
                    ...
                    <div class="mt-1 sm:mt-0 sm:col-span-2">
                        <div class="max-w-xs relative rounded-md shadow-sm">
                            ...
                            <input wire:model="income.amount" type="text" id="amount" class="block w-full pl-10 pr-12 border border-gray-300 rounded-md shadow-sm transition ease-in-out duration-150 focus:outline-none focus:ring focus:ring-indigo-500 focus:ring-opacity-20 focus:border-indigo-300 sm:text-sm" placeholder="0.00">
                        </div>
    ...
    <form wire:submit.prevent="destroy">
        <x-modal.confirmation wire:model.defer="showDeleteModal">
            <x-slot name="title">Delete Income</x-slot>

            <x-slot name="content">
                <div class="text-gray-700">Are you sure you want to delete <strong>{{ $income->title }} ?</strong> This action cannot be undone.</div>
            </x-slot>
